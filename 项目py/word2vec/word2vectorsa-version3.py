# -*- coding:utf-8 -*-
#相对版本2主要修改了相似度计算方法，余弦相似度取绝对值，PS：最后求出来的结果记得归一化
import logging
...
def get_predict_vecs(words):
    # print(words)
    n_dim = 100
    imdb_w2v =Word2Vec.load('Trained2.mod')
...
#训练模型部分
# trainmodel("out/w2vTrainData_V2.txt","Trained2.mod")
# #训练集目录
# trainset=[]
# for i in range(2,20):
